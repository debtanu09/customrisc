...
cmds = []
string = []
co = {'add':'0000', 'adc':'0000', 'adz':'0000', 'adi':'0001', 'ndu':'0010', 'ndc':'0010', 'ndz':'0010', 'lw':'0100', 'sw':'0101', 'lhi':'0011', 'beq':'1100', 'jal':'1000', 'jlr':'1001', 'mvi':'1010', 'mov':'1011'}
...
with open('code.asm','r') as f:
	...
	for cmd in cmds:
		...
		elif a[0] == 'lhi' or a[0] == 'jal' or a[0] == 'mvi':
